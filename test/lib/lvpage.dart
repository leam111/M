                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        child: Card(
                         ...
                         //InkWell lets ANY widget (Container, Card, Image, Row, etc.) be clickable
                          child: InkWell(
...
//cliprrect makes The image corners become rounded
                                  ...
                                  Icon(
                                    ...
                                    color: const Color.fromARGB(255, 145, 93, 235),
                                    size: 20,
                                  ),
                                ],
                              ),
